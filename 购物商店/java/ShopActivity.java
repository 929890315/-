...
public class ShopActivity extends Activity implements View.OnClickListener{
    ...
    //商品名称与价格数据集合
    private String[] titles = {"小米", "小米", "小米", "小米", "小米",
            "小米", "小米"};

    private String[] prices = {"9999元", "9999元", "9999元", "9999元", "9999元",
            "9999元","9999元"};

    private int[] icons = {R.drawable.xiaomi,R.drawable.xiaomi,R.drawable.xiaomi,R.drawable.xiaomi,R.drawable.xiaomi,
            R.drawable.xiaomi,R.drawable.xiaomi};
                ...
                vh.tvShopadd.setOnClickListener(new View.OnClickListener(){
                    ...
                    public void onClick(View v){
                        ...
                        if (sqLiteHelper.insertData(CarTitle,CarPrice)){
                            Toast.makeText(ShopActivity.this,"添加商品成功",Toast.LENGTH_SHORT).show();
                        }else{
